 ...
 <div class="col-sm-6 mx-auto ">
        <div class="card">
          <div class="card-header bg-light">
            <h5 class="card-title text-center" style="color:black">NEW COURSE</h5>
          </div>
           <?php 
                 if (@$_GET['Empty']==true)
                 {
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
          ...
          <div class="card-body">
            ...
            <form action="addcozlogic.php" method="post">
              <div class="form-group">
                <label for="code">Course Code</label>
                <input type="text" class="form-control" id="code" aria-describedby="emailHelp" placeholder="Enter Course Code" required="" name="cid">
               
              </div>
              <div class="form-group">
                <label for="name">Course Name</label>
                <input type="text" class="form-control" id="name" placeholder="Enter Course Name" required="" name="cname">
              </div>
              <div class="form-group">
