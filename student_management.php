...
<body class=" ">
  ...
  <a class="navbar-brand" href="#" style="color: white;font-weight:bolder ;">ICT STUDENT MANAGEMENT</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
     <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="new_student.php" style="color: black;font-weight: bolder;"><i class="fa fa-plus-square" style="color:white;font-size: 20px;">Add Student</i></a>
      </li>
     <li class="nav-item active">
        <a class="nav-link" href="update_student.php" style="color: black;font-weight: bolder;"><i class="fa fa-edit" style="color:white;font-size: 20px;">Update Student</i></a>
      </li>
       <li class="nav-item active">
        <a class="nav-link" href="clear.php" style="color: black;font-weight: bolder;"><i class="fa fa-trash" style="color:white;font-size: 20px;">Clear Student</i></a>
          ...
          <li class="nav-item active">
        <a class="nav-link" href="reports.php" style="color: black;font-weight: bolder;"><i class="fa fa-print" style="color:white;font-size: 20px;">Reports</i></a>
      </li>
