  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
          ...
          <div class="card-body">
            ...
            <form action="addstudentlogic.php" method="post">
              <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <select id="orders" name="dpt" class="form-control" onchange="getDetail(this.value),getlec(this.value)">
                  ...
                  <div class="form-group col-md-6">
                <label for="order-details"  style="font-weight: bolder;" >Course</label>
    ...
    <div class="form-group col-md-6">
             ...
             <div class="form-row">
              <div class="form-group col-md-6">
                <label for="lecturer"  style="font-weight: bolder;" >Lecturer</label>
                ...
                <select id="lecturer" name="lec" class="form-control" >
                  ...
                  <div class="form-group col-md-6">
                <label for="stt"  style="font-weight: bolder;">Status</label>
