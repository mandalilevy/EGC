...
$query=mysqli_query($con,"select * from businessstudent where unit = '".$_POST['unt']."' and time='".$_POST['time']."' and lecturer='".$_POST['lecc']."'");
...
$qq=mysqli_query($con,"select * from lecturer where name = '".$_POST['lecc']."'");
...
$pdf->Cell(50	,4,'NAME',1,0);
$pdf->Cell(50	,4,'Unit',1,0);
$pdf->Cell(20	,4,'Time',1,0);
...
while($item=mysqli_fetch_array($query)){
	$pdf->Cell(50,4,$item['name'],1,0);

	$pdf->Cell(50,4,$item['unit'],1,0);
	$pdf->Cell(20,4,$item['time'],1,0);
    $pdf->Cell(15,4," ",1,0);
	$pdf->Cell(15,4," ",1,0);
	$pdf->Cell(15,4," ",1,0);
	$pdf->Cell(15,4," ",1,0);
...
$ww=mysqli_query($con,"select * from lecturer where name = '".$_POST['lecc']."'");
