 ...
 <div class="col-sm-6 mx-auto ">
        <div class="card">
          <div class="card-header bg-light">
            <h5 class="card-title text-center" style="color:black">Update Unit Assignment</h5>
          </div>
           <?php 
                 if (@$_GET['Empty']==true)
                 {
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
          ...
          <div class="card-body">
            ...
            <form action="update_unit_assignment_logic.php" method="post">
                    <div class="form-group">
                <label for="orders"  style="font-weight:bolder;">Previous Lecturer</label>
            
                <select id="orders" name="plec" class="form-control">
                
                </select>
              </div>
                 <div class="form-group">
                <label for="clect"  style="font-weight:bolder;">New Lecturer</label>
            
                <select id="clect" name="lec" class="form-control">
...
<script type="text/javascript">
    ...
    function clec() {
        var ajax = new XMLHttpRequest();
        ajax.open("GET", "getclec.php", true);
        ajax.send();
        ...
        ajax.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("clect").innerHTML = html;
            }
        };
    }
    getOrders();
