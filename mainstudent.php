...
<body class=" ">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
     <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="student_management.php" style="color: black;font-weight: bolder;"><i class="fa fa-laptop" style="color:white;font-size: 20px;">ICT/Language Students</i></a>
      </li>
     <li class="nav-item active">
        <a class="nav-link" href="business.php" style="color: black;font-weight: bolder;"><i class="fa fa-money" style="color:white;font-size: 20px;">Business Students</i></a>
      </li>
